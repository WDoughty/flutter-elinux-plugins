...
#ifndef PACKAGES_VIDEO_PLAYER_VIDEO_PLAYER_ELINUX_MESSAGES_TOGGLE_FPS_MESSAGE_H_
#define PACKAGES_VIDEO_PLAYER_VIDEO_PLAYER_ELINUX_MESSAGES_TOGGLE_FPS_MESSAGE_H_
...
class ToggleFpsMessage {
 public:
  ToggleFpsMessage() = default;
  ~ToggleFpsMessage() = default;

  // Prevent copying.
  ToggleFpsMessage(ToggleFpsMessage const&) = default;
  ToggleFpsMessage& operator=(ToggleFpsMessage const&) = default;
  ...
  static ToggleFpsMessage FromMap(const flutter::EncodableValue& value) {
    ToggleFpsMessage message;
...
#endif  // PACKAGES_VIDEO_PLAYER_VIDEO_PLAYER_ELINUX_MESSAGES_TOGGLE_FPS_MESSAGE_H_
